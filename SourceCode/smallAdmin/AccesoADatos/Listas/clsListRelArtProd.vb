...
Public Class clsListRelArtProd
  'Inherits clsList(Of clsInfoArticuloVendido)
  'Public Sub New()
  '  Try
  '    Call init(10)
  ...
  '      Dim objListArticuloInfo As clsInfoArticulos
  '      Dim strCommand As String = "Articulos" ', (select max(bcospac.fecha) as LastVisitDate from BcosPac where BcosPac.idPac = Pac.idPac) as  LastVisitDate from Pac)"
  ...
  '          objListArticuloInfo = New clsInfoArticulos
  '          objResult = clsArticulo.ArticuloIgualDataRow(objListArticuloInfo, fila)
  '          If objResult <> Result.OK Then Return objResult

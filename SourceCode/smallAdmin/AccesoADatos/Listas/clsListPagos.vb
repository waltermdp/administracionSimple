...
Public Class clsListPagos
  Inherits clsList(Of clsInfoPagos)
  ...
  Protected Overrides Function RefreshData_Private() As libCommon.Comunes.Result
    Try
      ...
      Try
        ...
        Dim objListPagosInfo As clsInfoPagos
        ...
        If auxResult > 0 Then
          For Each fila As DataRow In objDatos.Table.Rows
            ...
            objListPagosInfo = New clsInfoPagos
            objResult = clsPago.PagoIgualDataRow(objListPagosInfo, fila)
            If objResult <> Result.OK Then Return objResult
            m_Items.Add(objListPagosInfo)

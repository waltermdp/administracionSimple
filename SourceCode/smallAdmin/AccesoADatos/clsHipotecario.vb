...
Public Class clsHipotecario
  ...
  Private Const CONVENIO As Integer = 6248
  ...
  Public Function GetExportedFile(ByVal vlstMovimientos As List(Of clsInfoMovimiento), ByRef rlineas As List(Of String), ByVal vSecuencial As Integer) As Result
    Try
      Dim auxLinea As String = String.Empty
      Dim lstResult As New List(Of String)
      Dim ImporteTotal As Decimal = 0
      ImporteTotal = vlstMovimientos.Sum(Function(c) c.Importe)
  ...
  Private Function GenerarDetalle(ByVal vMov As clsInfoMovimiento, ByVal vCodBanco As Integer, ByVal vFechaVencimiento As Date, ByRef rBody As String) As Result
    Try
      Dim sResult As String = String.Empty

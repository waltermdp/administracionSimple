...
Public Class frmLiquidacionVendedores
  ...
  Private Sub SearchPagos()
    Try
      ...
      m_objListPagos.Cfg_Filtro = "where EstadoPago = " & E_EstadoPago.Pago & " and FechaPago between #" & Format(dtInicio.Value, strFormatoAnsiStdFecha) & "# and #" & Format(dtFinal.Value, strFormatoAnsiStdFecha) & "#"
      ...
      'Dim strFilter As String = " where GuidProducto in ("
      'For Each pago In m_objListPagos.Items
      '  strFilter += "{" & pago.GuidProducto.ToString & "},"
      'Next
      'strFilter = strFilter.Remove(strFilter.Count - 1)
      'strFilter += ")"

...
Public Class frmImportarVisaCredito
  ...
  Public Sub New(ByVal vTipoPago As manDB.clsTipoPago)
    ...
    Try
      ...
      m_Banco = New clsVisaCredito(vTipoPago.GuidTipo)
  ...
  Private Sub Init()
    Try
      ...
      ClsInfoImportarVisaCreditoBindingSource.DataSource = m_Banco.m_Registros
      ClsInfoImportarVisaCreditoBindingSource.ResetBindings(False)

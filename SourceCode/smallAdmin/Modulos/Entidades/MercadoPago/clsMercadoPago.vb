...
#Region "Exportacion"
  ...
  Private Shared Function ExportarAVisaCredito(ByVal vMovimientos As List(Of clsInfoExportarMercadoPago)) As Result
    Try
      ...
      Try
        ...
        Dim lista As List(Of clsInfoExportarMercadoPago) = vMovimientos.OrderBy(Function(d) CInt(d.NumeroComprobante)).ToList
  ...
  Private Shared Function ExportVisaTXT(ByVal vMovimientos As List(Of clsInfoExportarMercadoPago), ByVal constante As String) As Result
    Try
      Dim lineas As New List(Of String)

...
Public Class clsCBU
  ...
  Public m_RegistrosExportar As New List(Of clsInfoExportarCBU)
...
#Region "Exportacion"
  ...
  Private Sub taskGenerateResumen(ByRef rResult As Result, ByRef rMessage As String)
    Try
      ...
      m_RegistrosExportar = New List(Of clsInfoExportarCBU)
      Dim movimiento As clsInfoExportarCBU
      ...
      For Each item In lstPago.Items
        movimiento = New clsInfoExportarCBU
  ...
  Private Sub taskGenerarExportacion(ByRef rResult As Result, ByRef rMessage As String)
    Try
      ...
      Dim Exportable As List(Of clsInfoExportarCBU) = m_RegistrosExportar.Where(Function(c) c.Exportar = True).ToList
  ...
  Public Function GetExportedFile(ByVal vlstRegistros As List(Of clsInfoExportarCBU), ByRef rlineas As List(Of String)) As Result
    Try

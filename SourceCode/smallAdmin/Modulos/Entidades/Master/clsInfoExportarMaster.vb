...
Public Class clsInfoExportarMaster


  'body
  Private m_TipoNovedad As String = "D"
  Private m_Cuit_DNI As Decimal
  Private m_NroTarjeta As Decimal
  ...
  Private m_PlanCuotas As Integer
  ...
  Public Property PlanCuotas As Integer
    Get
      Return m_PlanCuotas
    End Get
    Set(value As Integer)
  ...
  Public Property NroTarjeta As Decimal
    Get
      Return m_NroTarjeta
    End Get
    Set(value As Decimal)
